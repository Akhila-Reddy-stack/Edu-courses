...
class Chapters extends PureComponent {
    ...
    componentDidMount = async () => {
        ...
        axios({
            method: 'get',
            url: `https://eduinterview.appsfactory.io/api/rest/courses/${this.state.courseId}`,
            headers: {
            ...
            await this.setState({
                ...
                imageUrl: `https://res.cloudinary.com/kraftycrux/image/upload/w_160,h_224,dpr_auto/${responseData?.data.eduinterview_courses[0]?.big_image}`
                    ...
                    <div className="content">
                        {Chapters?.map(chap => (
                            <div>
                                ...
                                <img src={this.state.imageUrl} class="con-img-bg" />
                                <div className="content-inner">
                                    <ArrowBackIosIcon className="content-arrow" onClick={this.arrowback} />
                                ...
                                <div className="content-reels">
                                    {chap?.chapters?.length === 0 &&
                                        <div className="nochapters">No Chapters</div>
                                    }
                                    {chap?.chapters?.length != 0 &&
                                        <div>
